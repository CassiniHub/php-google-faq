    ...
    <?php
        $db = [
            "questions" => [
                ...
                => [
                    "answer" => [
                        "subtitles" => ["Stabilire il paese associato al tuo account"],
                        "text"      => [
        ...
        foreach ($db as $questions_key => $questions_arr) {
            foreach ($questions_arr as $question_text => $answer_arr) {
                echo "<h2>" . $question_text . "</h2>";
    
                foreach ($answer_arr as $answer_headings) {
                    echo "<h3>" . $answer_headings['subtitles'][0] . "</h3>"
                        . "<p>" . $answer_headings['text'][0] . "</p>";                
                }
            }
        }
    ?>
